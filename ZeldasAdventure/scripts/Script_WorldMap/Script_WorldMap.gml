...
function WorldMap_Tiles_Init()
{
	...
	//Overworld
		...
		[Maps.Overworld		,18		,4		,7			,MapTileType.ShrineEntrance		,18		,4		],	//7
		[Maps.Overworld		,20		,4		,16			,MapTileType.Shortcut			,-1		,-1		],	//8
		[Maps.Overworld		,21		,4		,9			,MapTileType.Shortcut			,21		,4		],	//9
		...
		[Maps.Overworld		,25		,4		,13			,MapTileType.ShrineEntrance		,25		,4		],	//13
		[Maps.Overworld		,17		,5		,14			,MapTileType.Regular			,17		,5		],	//14
		[Maps.Overworld		,18		,5		,15			,MapTileType.Regular			,18		,5		],	//15
		[Maps.Overworld		,19		,5		,16			,MapTileType.Shortcut			,19		,5		],	//16
		...
		[Maps.Overworld		,1		,6		,23			,MapTileType.ShrineEntrance		,1		,6		],	//23
		[Maps.Overworld		,2		,6		,24			,MapTileType.Regular			,2		,6		],	//24
		[Maps.Overworld		,3		,6		,25			,MapTileType.Regular			,3		,6		],	//25
		[Maps.Overworld		,4		,6		,26			,MapTileType.Shop				,4		,6		],	//26
		[Maps.Overworld		,5		,6		,27			,MapTileType.Regular			,5		,6		],	//27
		[Maps.Overworld		,13		,6		,90			,MapTileType.Interior			,-1		,-1		],	//28
		...
		[Maps.Overworld		,11		,7		,40			,MapTileType.ShrineEntrance		,11		,7		],	//40
		...
		[Maps.Overworld		,22		,7		,50			,MapTileType.FairyFountain		,22		,7		],	//50
		...
		[Maps.Overworld		,13		,8		,58			,MapTileType.FairyFountain		,13		,8		],	//58
		...
		[Maps.Overworld		,13		,10		,90			,MapTileType.Interior			,13		,10		],	//90
		[Maps.Overworld		,14		,10		,91			,MapTileType.Interior			,14		,10		],	//91
		[Maps.Overworld		,15		,10		,92			,MapTileType.Regular			,15		,10		],	//92
		[Maps.Overworld		,16		,10		,91			,MapTileType.Interior			,-1		,-1		],	//93
		...
		[Maps.Overworld		,7		,11		,110		,MapTileType.Interior			,-1		,-1		],	//97
		[Maps.Overworld		,8		,11		,110		,MapTileType.Interior			,-1		,-1		],	//98
		[Maps.Overworld		,9		,11		,111		,MapTileType.Interior			,-1		,-1		],	//99
		...
		[Maps.Overworld		,15		,11		,105		,MapTileType.Shop				,15		,11		],	//105
		...
		[Maps.Overworld		,9		,12		,120		,MapTileType.Interior			,-1		,-1		],	//109
		[Maps.Overworld		,10		,12		,110		,MapTileType.Interior			,10		,12		],	//110
		[Maps.Overworld		,11		,12		,111		,MapTileType.Interior			,11		,12		],	//111
		...
		[Maps.Overworld		,10		,13		,119		,MapTileType.Shop				,10		,13		],	//119
		[Maps.Overworld		,11		,13		,120		,MapTileType.Interior			,11		,13		],	//120
		...
		[Maps.Overworld		,21		,13		,128		,MapTileType.Shop				,21		,13		],	//128
		...
		[Maps.Overworld		,21		,15		,163		,MapTileType.Interior			,21		,15		],	//163
		...
		[Maps.Overworld		,22		,16		,163		,MapTileType.Interior			,-1		,-1		],	//181
		...
		[Maps.Overworld		,27		,16		,185		,MapTileType.ShrineEntrance		,27		,16		],	//185
		...
		[Maps.Overworld		,28		,17		,197		,MapTileType.FairyFountain		,28		,17		],	//197
		...
		[Maps.Overworld		,15		,18		,215		,MapTileType.Interior			,-1		,-1		],	//201
		...
		[Maps.Overworld		,15		,19		,215		,MapTileType.Interior			,15		,19		],	//215
		...
		[Maps.Overworld		,19		,19		,219		,MapTileType.Shop				,19		,19		],	//219
		...
		[Maps.Overworld		,9		,20		,227		,MapTileType.Shortcut			,9		,20		],	//227
		[Maps.Overworld		,12		,20		,227		,MapTileType.Shortcut			,-1		,-1		],	//228
		...
		[Maps.Overworld		,9		,21		,235		,MapTileType.Interior			,9		,21		],	//235
		[Maps.Overworld		,10		,21		,235		,MapTileType.Interior			,-1		,-1		],	//236
		[Maps.Overworld		,14		,21		,237		,MapTileType.Shortcut			,14		,21		],	//237
		...
		[Maps.Overworld		,12		,23		,260		,MapTileType.Interior			,-1		,-1		],	//253
		...
		[Maps.Overworld		,11		,25		,273		,MapTileType.Interior			,-1		,-1		],	//268
		...
		[Maps.Overworld		,11		,26		,273		,MapTileType.Interior			,11		,26		],	//273
		...
		[Maps.Overworld		,17		,28		,289		,MapTileType.ShrineEntrance		,17		,28		],	//289
		[Maps.Overworld		,6		,29		,290		,MapTileType.Regular			,6		,29		],	//290
		[Maps.Overworld		,6		,30		,291		,MapTileType.Regular			,6		,30		],	//291
		[Maps.Overworld		,6		,31		,292		,MapTileType.ShrineEntrance		,6		,31		],	//292
		[Maps.Overworld		,7		,31		,292		,MapTileType.ShrineEntrance		,7		,31		],	//293
	//Shrine 1 (Earth)
		//MapID				,TileX	,TileY	,TileID		,TileType					,MapX	,MapY
