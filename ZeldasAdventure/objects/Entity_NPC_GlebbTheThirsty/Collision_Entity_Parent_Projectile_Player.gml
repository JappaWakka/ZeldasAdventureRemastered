if global.RemasteredMode = true and global.CurrentDialogue_Asset = Dialog_None and Register_Registered(Registers.GlebbTheThirsty_Attacked) = false
{
	...
	Register_Add(Registers.GlebbTheThirsty_Attacked,true)
}