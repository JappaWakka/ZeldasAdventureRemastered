if EnemyState != EnemyStates.Damaged
{
	...
	switch direction
	{
		case global.Directions.East :
			sprite_index = Sprite_NPC_ShopkeeperDog_East
			break;
		case global.Directions.South :
			sprite_index = Sprite_NPC_ShopkeeperDog_South
			break;
		case global.Directions.West :
			sprite_index = Sprite_NPC_ShopkeeperDog_West
			break;
		case global.Directions.North :
			sprite_index = Sprite_NPC_ShopkeeperDog_North
			break;
	}
