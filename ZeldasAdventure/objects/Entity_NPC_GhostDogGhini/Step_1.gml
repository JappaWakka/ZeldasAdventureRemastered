if EnemyState != EnemyStates.Damaged
{
	...
	switch direction
	{
		case global.Directions.East :
			sprite_index = Sprite_NPC_GhostDogGhini_East
			break;
		case global.Directions.South :
			sprite_index = Sprite_NPC_GhostDogGhini_South
			break;
		case global.Directions.West :
			sprite_index = Sprite_NPC_GhostDogGhini_West
			break;
		case global.Directions.North :
			sprite_index = Sprite_NPC_GhostDogGhini_North
			break;
	}
