if global.RemasteredMode = true and global.CurrentDialogue_Asset = Dialog_None and Register_Registered(Registers.BeggarWoman_Attacked) = false
{
	...
	Register_Add(Registers.BeggarWoman_Attacked,true)
}