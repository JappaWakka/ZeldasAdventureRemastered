if EnemyState != EnemyStates.Damaged
{
	...
	switch direction
	{
		case global.Directions.East :
			sprite_index = Sprite_Enemy_Bounder_East
			break;
		case global.Directions.South :
			sprite_index = Sprite_Enemy_Bounder_South
			break;
		case global.Directions.West :
			sprite_index = Sprite_Enemy_Bounder_West
			break;
		case global.Directions.North :
			sprite_index = Sprite_Enemy_Bounder_North
			break;
	}
