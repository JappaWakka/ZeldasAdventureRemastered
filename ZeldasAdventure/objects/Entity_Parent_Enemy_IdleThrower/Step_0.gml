...
if IsPlayerOnSameTile_EnemyOrNPC() = true && global.CameraIsFading = false
{
	...
	if EnemyState = EnemyStates.Attack && floor(image_index) = ThrowProjectileFrame
	{
		...
		var Projectile = instance_create_layer(x + xOffset,y + yOffset,"Temporary_BelowPlayer",ProjectileAsset)
